...
const CHART_PROMPT_HINTS: Record<SupportedAnalysisChartType, string> = {
  ...
  wuxing_energy: '适合展示五行能量分布，data 需包含 elements、favorableElement、unfavorableElement、advice、interactions；请额外包含 strengthLevel（veryWeak/weak/balanced/strong/veryStrong）、favorableElements、unfavorableElements',
