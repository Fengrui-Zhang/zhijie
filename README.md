...
- **四柱八字**：公历、农历、四柱输入，精确时间与快捷时辰，真太阳时校准，命例管理，专业排盘，点击干支/藏干查看象意、十神、根源与份额，大运/流年/流月/流日，十神与神煞，AI 五行分析、AI 人格分析、断事笔记和人生 K 线。
...
- 八字“一字溯源”在前端实时计算，岁运切换同步更新；默认计份口径和补充规则见 [来源单位制说明](docs/bazi-source-units.md)。
